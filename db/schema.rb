...
ActiveRecord::Schema.define(version: 2020_07_13_213740) do
  ...
  create_table "member_applications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "school_attended_1"
    t.string "school_years_1"
    t.string "major_1"
    t.string "graduate_1"
    t.string "school_attended_2"
    t.string "school_years_2"
    t.string "major_2"
    t.string "graduate_2"
    t.string "school_attended_3"
    t.string "school_years_3"
    t.string "major_3"
    t.string "graduate_3"
    t.string "employer_1"
    t.string "work_title_1"
    t.string "employer_2"
    t.string "employer_3"
    t.string "employer_4"
    t.string "employer_5"
    t.string "work_type_1"
    t.string "work_title_2"
    t.string "work_type_2"
    t.string "work_title_3"
    t.string "work_type_3"
    t.string "work_title_4"
    t.string "work_type_4"
    t.string "work_title_5"
    t.string "work_type_5"
    ...
    t.string "hospital_name_2"
    t.string "hospital_name_3"
    t.string "hospital_name_4"
    t.string "hospital_name_5"
    t.string "hospital_name_6"
    t.string "hospital_name_7"
    t.string "hospital_name_8"
    t.string "hospital_name_9"
    t.string "hospital_name_10"
    ...
    t.string "what_challenges"
    t.string "children_number"
    t.string "other_sup_text"
    ...
    t.text "dsm_v"
    t.text "hosp_precip_1"
    t.text "hosp_precip_2"
    t.text "hosp_precip_3"
    t.text "hosp_precip_4"
    t.text "hosp_precip_5"
    t.text "hosp_precip_6"
    t.text "hosp_precip_7"
    t.text "hosp_precip_8"
    t.text "hosp_precip_9"
    t.text "hosp_precip_10"
    t.text "abuse_history_elaboration"
    ...
    t.integer "eth_na"
    t.integer "eth_aa_ac"
    t.integer "eth_aa_other"
    t.integer "eth_aa_unknown"
    t.integer "eth_aa_na"
    t.integer "eth_cuban"
    t.integer "eth_mex"
    t.integer "eth_pr"
    ...
    t.integer "sub_abuse_check"
    t.integer "work_prog_check"
    ...
    t.date "work_start_date_2"
    t.date "work_end_date_2"
    t.date "work_start_date_3"
    t.date "work_end_date_3"
    t.date "work_start_date_4"
    t.date "work_end_date_4"
    t.date "work_start_date_5"
    t.date "work_end_date_5"
    t.date "last_physical_exam_date"
    t.date "last_dental_exam_date"
    t.date "hospital_start_date_1"
    t.date "hospital_end_date_1"
    t.date "hospital_start_date_2"
    t.date "hospital_end_date_2"
    t.date "hospital_start_date_3"
    t.date "hospital_end_date_3"
    t.date "hospital_start_date_4"
    t.date "hospital_end_date_4"
    t.date "hospital_start_date_5"
    t.date "hospital_end_date_5"
    t.date "hospital_start_date_6"
    t.date "hospital_end_date_6"
    t.date "hospital_start_date_7"
    t.date "hospital_end_date_7"
    t.date "hospital_start_date_8"
    t.date "hospital_end_date_8"
    t.date "hospital_start_date_9"
    t.date "hospital_end_date_9"
    t.date "hospital_start_date_10"
    t.date "hospital_end_date_10"
