class MemberApplicationsController < ApplicationController
  ...
  def create
    ...
    if @member_application.save
      redirect_to new_member_application_path, notice: "Your application was submitted successfully" 
    else
  ...
  def member_application_params
    params.require(:member_application).permit(
      ...
      :hospital_start_date_10, :hospital_end_date_10, :psych_social, :psych_eval, :insurance_card
    )
  end
end
